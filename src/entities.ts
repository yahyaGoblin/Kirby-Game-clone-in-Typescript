import {
  ...
  //player function like collision detection, spawn, damage detect and inhale effect 
  ...
  export function setControls(k: KaboomCtx, player: PlayerGameObj) {
    ...
    // inhale button press detect and anim 
    k.onKeyRelease((key) => {
      switch (key) {
        case "z":
          if (player.isFull) {
  ...
  //detects if enemy is in inhale zone and changes between full and empty krib
  ...
  // makes the enemy hitbox and makes it move
